...
<form method='post' action='update_action.php?edit_form=<?php echo $Employee_id; ?>'>
...
<td align="center" width="400"><input type="text" name="id2" value='<?php echo  $Employee_id; ?>' style="width:400px"></td>
</tr>
<tr>
